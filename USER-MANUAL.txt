...
Current state: `0.1.1` contract repository foundation release. CivicContracts does not provide official legal interpretation, legal advice, live contract management platforms, live LLM calls, contract execution workflows, renewal approvals, or contract system-of-record updates. Staff own every decision.
...
CivicContracts depends on CivicCore. CivicCore does not depend on CivicContracts. CivicContracts v0.1.1 uses deterministic sample contract data only; live contract management platforms, CivicRecords file links, staff review queues, and production contract-system integrations are future work.
